...
INSERT INTO books (author, title, isbn, image_url, description)
VALUES('Public Library of New South Wales', 'Guide to the System of Cataloguing of the Reference Library', 'OTHER' ,'https://books.google.com/books/content?id=IxU9AAAAYAAJ&printsec=frontcover&img=1&zoom=5&source=gbs_api','no description available')
